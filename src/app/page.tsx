...
import { BookOpen, Info, MapPin, Sparkles } from 'lucide-react'
			...
			<div className="flex flex-col gap-6">
				...
				<ul className="flex flex-col gap-4">
					<li className="flex gap-2.5 items-baseline">
						...
						descubra a variedade de Unidades de Conservação do Rio Grande do
						Sul.
					</li>
					<li className="flex gap-2.5 items-baseline">
					...
					<li className="flex gap-2.5 items-baseline">
						...
						conhecimento sobre a importância e os benefícios das áreas
						protegidas.
					</li>
				</ul>
			</div>
